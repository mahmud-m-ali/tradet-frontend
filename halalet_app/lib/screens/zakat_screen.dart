...
class _ZakatScreenState extends State<ZakatScreen> {
        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: const Row(
                children: [
                  Icon(Icons.info_outline, color: HalalEtTheme.accent, size: 22),
                  SizedBox(width: 12),
                  Expanded(child: Text(
  ...
  Widget _methodChip(String label, String value) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected
              ? HalalEtTheme.accent.withValues(alpha: 0.2)
              : HalalEtTheme.surfaceLight,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: selected ? HalalEtTheme.accent : HalalEtTheme.divider,
          ),
        ),
        child: Center(child: Text(label,
            style: TextStyle(
              fontWeight: selected ? FontWeight.w700 : FontWeight.w500,
              color: selected ? HalalEtTheme.accent : HalalEtTheme.textSecondary,
            ))),
      ),
    );
  }
  ...
  Widget _buildResultCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: isObligatory ? HalalEtTheme.heroGradient : null,
        color: isObligatory ? null : HalalEtTheme.cardBg,
        borderRadius: BorderRadius.circular(20),
        boxShadow: isObligatory
            ? [BoxShadow(color: HalalEtTheme.primary.withValues(alpha: 0.3),
