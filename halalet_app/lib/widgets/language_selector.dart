        ...
        return PopupMenuButton<String>(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                const Icon(Icons.language, size: 16, color: HalalEtTheme.accent),
                ...
                const Icon(Icons.arrow_drop_down, size: 16, color: HalalEtTheme.textMuted),
              ],
            ),
          ),
        );
  ...
  PopupMenuItem<String> _buildItem(String code, String label, bool selected) {
    return PopupMenuItem<String>(
      ...
      child: Row(
        children: [
          if (selected)
            const Icon(Icons.check, size: 16, color: HalalEtTheme.positive)
          else
