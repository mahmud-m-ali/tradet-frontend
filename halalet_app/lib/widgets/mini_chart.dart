...
class MiniSparkline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final lineColor = color ?? (isPositive ? HalalEtTheme.positive : HalalEtTheme.negative);
...
class _TradingChartState extends State<TradingChart> {
  ...
  Widget build(BuildContext context) {
    ...
    final lineColor = widget.lineColor ??
        (isPositive ? HalalEtTheme.positive : HalalEtTheme.negative);
          ...
          Row(
            children: [
              const Text('Price Chart',
                  style: TextStyle(
                      color: HalalEtTheme.textPrimary,
              ...
              LineChartData(
                      ...
                      getTitlesWidget: (value, meta) {
                        return Text(
                          ...
                          style: const TextStyle(
                              color: HalalEtTheme.textMuted, fontSize: 10),
                        );
                      },
                    ),
                  ),
                ...
                lineTouchData: LineTouchData(
                  touchTooltipData: LineTouchTooltipData(
                    getTooltipColor: (_) => HalalEtTheme.primaryDark,
